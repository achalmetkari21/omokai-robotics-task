...
bool mission_interfaces__msg__mission__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mission_interfaces.msg._mission.Mission", full_classname_dest, 39) == 0);
  }
  mission_interfaces__msg__Mission * ros_message = _ros_message;
  {  // command
...
PyObject * mission_interfaces__msg__mission__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mission_interfaces.msg._mission");
